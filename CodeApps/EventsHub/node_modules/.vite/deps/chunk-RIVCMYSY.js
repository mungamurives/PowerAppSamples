  ...
  (function() {
    ...
    Async2.prototype.throttle = function(func, wait, options) {
      ...
      var callback = function(userCall) {
        var now3 = Date.now();
        var delta = now3 - lastExecuteTime;
        var waitLength = leading ? waitMS - delta : waitMS;
        if (delta >= waitMS && (!userCall || leading)) {
          lastExecuteTime = now3;
          if (timeoutId) {
    ...
    Async2.prototype.debounce = function(func, wait, options) {
      ...
      var callback = function(userCall) {
        ...
        if (userCall) {
          if (leading && now3 - lastCallTime >= waitMS) {
            executeImmediately = true;
          }
          lastCallTime = now3;
        }
        var delta = now3 - lastCallTime;
        var waitLength = waitMS - delta;
        var maxWaitDelta = now3 - lastExecuteTime;
...
function getParent(child, allowVirtualParents) {
  ...
  if (typeof child.assignedElements !== "function" && ((_a3 = child.assignedSlot) === null || _a3 === void 0 ? void 0 : _a3.parentNode)) {
...
function portalContainsElement(target, parent, doc) {
  ...
  var elementMatch = findElementRecursive(target, function(testElement) {
    var _a4;
    return parent === testElement || !!((_a4 = testElement.hasAttribute) === null || _a4 === void 0 ? void 0 : _a4.call(testElement, DATA_PORTAL_ATTRIBUTE));
  }, doc);
  return elementMatch !== null && !!((_a3 = elementMatch.hasAttribute) === null || _a3 === void 0 ? void 0 : _a3.call(elementMatch, DATA_PORTAL_ATTRIBUTE));
}
...
function focusFirstChild(rootElement, bypassHiddenElements, includeShadowRoots) {
  var element = getNextElement(rootElement, rootElement, true, false, false, true, void 0, void 0, bypassHiddenElements, includeShadowRoots);
  if (element) {
    focusAsync(element);
    return true;
  }
...
function getPreviousElement(rootElement, currentElement, checkNode, suppressParentTraversal, traverseChildren, includeElementsInFocusZones, allowFocusRoot, tabbable, includeShadowRoots) {
  ...
  if (traverseChildren && isCurrentElementVisible && (includeElementsInFocusZones || !(isElementFocusZone(currentElement) || isElementFocusSubZone(currentElement)))) {
    var lastElementChild = currentElement.lastElementChild || includeShadowRoots && ((_a3 = currentElement.shadowRoot) === null || _a3 === void 0 ? void 0 : _a3.lastElementChild);
...
function getNextElement(rootElement, currentElement, checkNode, suppressParentTraversal, suppressChildTraversal, includeElementsInFocusZones, allowFocusRoot, tabbable, bypassHiddenElements, includeShadowRoots) {
  ...
  if (!suppressChildTraversal && isCurrentElementVisible && (includeElementsInFocusZones || !(isElementFocusZone(currentElement) || isElementFocusSubZone(currentElement)))) {
    var firstElementchild = currentElement.firstElementChild || includeShadowRoots && ((_a3 = currentElement.shadowRoot) === null || _a3 === void 0 ? void 0 : _a3.firstElementChild);
...
function getFirstVisibleElementFromSelector(selector) {
  ...
  return Array.from(elements).find(function(element) {
    var _a3;
    return isElementVisibleAndNotHidden(element, (_a3 = doc.defaultView) !== null && _a3 !== void 0 ? _a3 : void 0);
  });
}
...
var Stylesheet = (
  ...
  (function() {
    function Stylesheet2(config, serializedStylesheet) {
      ...
      this._config = __assign({ injectionMode: typeof document === "undefined" ? InjectionMode.none : InjectionMode.insertNode, defaultPrefix: "css", namespace: void 0, cspSettings: void 0 }, config);
    ...
    Stylesheet2.prototype.insertRule = function(rule, preserve, stylesheetKey) {
      ...
      this._onInsertRuleCallbacks.forEach(function(callback) {
        return callback({ key: stylesheetKey, sheet: element ? element.sheet : void 0, rule });
      });
    };
    ...
    Stylesheet2.prototype._createStyleElement = function() {
      var _a3;
      var doc = ((_a3 = this._config.window) === null || _a3 === void 0 ? void 0 : _a3.document) || document;
      var head = doc.head;
    ...
    Stylesheet2.prototype._insertRuleIntoSheet = function(sheet, rule) {
      if (!sheet) {
        return false;
      }
      try {
    ...
    Stylesheet2.prototype._getCacheKey = function(key) {
      return key;
    };
...
function extractSelector(currentSelector, rules2, selector, value, stylesheet3) {
  if (rules2 === void 0) {
    rules2 = { __order: [] };
  }
  if (selector.indexOf("@") === 0) {
    selector = selector + "{" + currentSelector;
    extractRules([value], rules2, selector, stylesheet3);
  } else if (selector.indexOf(",") > -1) {
    expandCommaSeparatedGlobals(selector).split(",").map(function(s) {
      return s.trim();
    }).forEach(function(separatedSelector) {
      return extractRules([value], rules2, expandSelector(separatedSelector, currentSelector), stylesheet3);
    });
  } else {
    extractRules([value], rules2, expandSelector(selector, currentSelector), stylesheet3);
  }
}
function extractRules(args, rules2, currentSelector, stylesheet3) {
  if (rules2 === void 0) {
    rules2 = { __order: [] };
  }
  ...
  for (var _i = 0, args_1 = args; _i < args_1.length; _i++) {
    ...
    if (typeof arg === "string") {
      ...
      if (expandedRules) {
        extractRules(expandedRules, rules2, currentSelector, stylesheet3);
      }
    } else if (Array.isArray(arg)) {
      extractRules(arg, rules2, currentSelector, stylesheet3);
    } else {
      for (var prop in arg) {
          ...
          if (prop === "selectors") {
            ...
            for (var newSelector in selectors) {
              if (selectors.hasOwnProperty(newSelector)) {
                extractSelector(currentSelector, rules2, newSelector, selectors[newSelector], stylesheet3);
              }
            }
          } else if (typeof propValue === "object" || isSelector(prop)) {
            if (propValue !== null && propValue !== void 0) {
              extractSelector(currentSelector, rules2, prop, propValue, stylesheet3);
            }
          } else {
            if (propValue !== void 0) {
...
function styleToRegistration(options) {
  ...
  var stylesheet3 = (_a3 = options.stylesheet) !== null && _a3 !== void 0 ? _a3 : Stylesheet.getInstance(options.shadowConfig);
  var rules2 = extractRules(args, void 0, void 0, stylesheet3);
  ...
  if (key) {
    ...
    if (!registration.className) {
      ...
      var rulesToInsert = [];
      for (var _b = 0, _c = rules2.__order; _b < _c.length; _b++) {
        var selector = _c[_b];
...
function applyRegistration(registration, specificityMultiplier, shadowConfig, sheet) {
  ...
  var stylesheet3 = sheet !== null && sheet !== void 0 ? sheet : Stylesheet.getInstance(shadowConfig);
...
function mergeCss(args, options) {
  ...
  var _a3 = extractStyleParts(opts.stylesheet, styleArgs), classes = _a3.classes, objects = _a3.objects;
  if (objects.length) {
...
function mergeCssSets(styleSets, options) {
  ...
  var opts = __assign(__assign({}, options), { shadowConfig });
  ...
  for (var styleSetArea in concatenatedStyleSet) {
    if (concatenatedStyleSet.hasOwnProperty(styleSetArea)) {
      ...
      var _a3 = extractStyleParts(sheet, styles), classes = _a3.classes, objects = _a3.objects;
...
var copyOldGlobalRules = function(stylesheet3, inShadow, win, doc) {
  var _a3;
  if (inShadow === void 0) {
    inShadow = false;
  }
  ...
  if (oldGlobalRules) {
    ...
    for (var i = 0; i < oldGlobalRules.length; i++) {
      ...
      var cssRules = ((_a3 = styleElem.sheet) === null || _a3 === void 0 ? void 0 : _a3.cssRules) || [];
      for (var j = 0; j < cssRules.length; j++) {
        var rule = cssRules[j];
        stylesheet3.insertRule(rule.cssText);
      }
    }
  }
};
var ShadowDomStylesheet = (
  /** @class */
  (function(_super) {
    __extends(ShadowDomStylesheet2, _super);
    function ShadowDomStylesheet2(config, serializedStylesheet) {
      var _this = _super.call(this, config, serializedStylesheet) || this;
      _this._onAddSheetCallbacks = [];
      _this._sheetCounter = 0;
      _this._adoptableSheets = /* @__PURE__ */ new Map();
      _global2[SHADOW_DOM_STYLESHEET_SETTING] = ShadowDomStylesheet2;
      return _this;
    }
    ShadowDomStylesheet2.getInstance = function(shadowConfig) {
      ...
      var win = sConfig.window || (typeof window !== "undefined" ? window : void 0);
      var global2 = win || _global2;
      var doc = win ? win.document : typeof document !== "undefined" ? document : void 0;
      _stylesheet2 = global2[STYLESHEET_SETTING];
      var oldStylesheetInitializedFirst = _stylesheet2 && !_stylesheet2.getAdoptedSheets;
      if (!_stylesheet2 || oldStylesheetInitializedFirst || _stylesheet2._lastStyleElement && _stylesheet2._lastStyleElement.ownerDocument !== doc) {
        var fabricConfig = (global2 === null || global2 === void 0 ? void 0 : global2.FabricConfig) || {};
        ...
        var stylesheet3 = void 0;
        if (oldStylesheetInitializedFirst) {
          stylesheet3 = new ShadowDomStylesheet2(fabricConfig.mergeStyles, JSON.parse(_stylesheet2.serialize()));
          copyOldGlobalRules(stylesheet3, inShadow, win, doc);
        } else {
          stylesheet3 = new ShadowDomStylesheet2(fabricConfig.mergeStyles, fabricConfig.serializedStylesheet);
        }
        _stylesheet2 = stylesheet3;
        global2[STYLESHEET_SETTING] = _stylesheet2;
      } else {
        _stylesheet2.setConfig({
          window: win,
          inShadow,
          stylesheetKey
        });
      ...
      if (win) {
        _stylesheet2._getAdoptableStyleSheet(stylesheetKey);
      }
      return _stylesheet2;
    };
    ShadowDomStylesheet2.prototype.getAdoptedSheets = function() {
      return this._adoptableSheets;
    };
    ShadowDomStylesheet2.prototype.onAddSheet = function(callback) {
      var _this = this;
    ...
    ShadowDomStylesheet2.prototype.insertRule = function(rule, preserve) {
      var _a3 = this._config, injectionMode = _a3.injectionMode, _b = _a3.stylesheetKey, stylesheetKey = _b === void 0 ? GLOBAL_STYLESHEET_KEY : _b;
    ...
    ShadowDomStylesheet2.prototype._getCacheKey = function(key) {
      var _a3 = this._config, _b = _a3.inShadow, inShadow = _b === void 0 ? false : _b, _c = _a3.stylesheetKey, currentStylesheetKey = _c === void 0 ? GLOBAL_STYLESHEET_KEY : _c;
      if (inShadow) {
        return "__".concat(currentStylesheetKey, "__").concat(key);
      }
      return _super.prototype._getCacheKey.call(this, key);
    };
    ShadowDomStylesheet2.prototype._createStyleElement = function() {
    ...
    ShadowDomStylesheet2.prototype._makeCSSStyleSheet = function() {
      var win = this._config.window || window;
      var sheet = void 0;
      if (!SUPPORTS_CONSTRUCTABLE_STYLESHEETS) {
    ...
    ShadowDomStylesheet2.prototype._addAdoptableStyleSheet = function(key, sheet, queue) {
      var _this = this;
      if (queue === void 0) {
        queue = true;
      }
        ...
        if (queue && win) {
          win.queueMicrotask(function() {
            _this._onAddSheetCallbacks.forEach(function(callback) {
              return callback({ key, sheet });
            });
          });
        }
      }
    };
    ShadowDomStylesheet2.prototype._getAdoptableStyleSheet = function(key) {
...
function classNamesFunction(options) {
  ...
  var getClassNames = function(styleFunctionOrObject, styleProps) {
    ...
    if (!windowMap.has(key)) {
      windowMap.set(key, /* @__PURE__ */ new Map());
    }
    ...
    if (disableCaching || !current[retVal]) {
      if (styleFunctionOrObject === void 0) {
        ...
        current[retVal] = mergeCssSets([
          ...
          rtl: !!rtl,
          specificityMultiplier: options.useStaticStyles ? DEFAULT_SPECIFICITY_MULTIPLIER : void 0
        });
      }
      if (!disableCaching) {
        styleCalcCount++;
...
var MergeStylesDefaultContext = React7.createContext(getNewContext());

// node_modules/@fluentui/utilities/lib/shadowDom/hooks/useMergeStylesHooks.js
var useMergeStylesHooks = function() {
  var ctx = React8.useContext(MergeStylesDefaultContext);
  return {
...
var MergeStylesShadowRootContext = React9.createContext(void 0);
var MergeStylesShadowRootProvider = function(_a3) {
  var shadowRoot = _a3.shadowRoot, props = __rest(_a3, ["shadowRoot"]);
  ...
  return React9.createElement(
    ...
    __assign({ value }, props),
    React9.createElement(GlobalStyles, null),
    props.children
  );
};
var GlobalStyles = function(props) {
  var useAdoptedStylesheet2 = useMergeStylesHooks().useAdoptedStylesheet;
  useAdoptedStylesheet2(GLOBAL_STYLESHEET_KEY);
  return null;
};
...
var useMergeStylesShadowRootContext = function() {
  return React10.useContext(MergeStylesShadowRootContext);
};

// node_modules/@fluentui/react-window-provider/lib/WindowProvider.js
var React11 = __toESM(require_react());
var WindowContext = React11.createContext({
  // eslint-disable-next-line no-restricted-globals
  window: typeof window === "object" ? window : void 0
});
var useWindow = function() {
  return React11.useContext(WindowContext).window;
};
var useDocument = function() {
  var _a3;
  return (_a3 = React11.useContext(WindowContext).window) === null || _a3 === void 0 ? void 0 : _a3.document;
};
var WindowProvider = function(props) {
  return React11.createElement(WindowContext.Provider, { value: props }, props.children);
};
...
var MergeStylesShadowRootConsumer = function(_a3) {
  var stylesheetKey = _a3.stylesheetKey, children = _a3.children;
  var _b = useMergeStylesHooks(), useAdoptedStylesheetEx2 = _b.useAdoptedStylesheetEx, useMergeStylesRootStylesheets2 = _b.useMergeStylesRootStylesheets, useWindow2 = _b.useWindow;
  var shadowCtx = useMergeStylesShadowRootContext();
  var rootMergeStyles = useMergeStylesRootStylesheets2();
  var win = useWindow2();
  useAdoptedStylesheetEx2(GLOBAL_STYLESHEET_KEY, shadowCtx, rootMergeStyles, win);
  useAdoptedStylesheetEx2(stylesheetKey, shadowCtx, rootMergeStyles, win);
...
var mergeComponentStyles = memoizeFunction(
  ...
  function(defaultStyles, componentStyles, shadowConfig) {
    var _a3;
    var styles = (_a3 = componentStyles !== null && componentStyles !== void 0 ? componentStyles : defaultStyles) !== null && _a3 !== void 0 ? _a3 : {};
  ...
  return function customizableFactory(ComposedComponent) {
    ...
    (function(_super) {
      ...
      ComponentWithInjectedProps.prototype.render = function() {
        var _this = this;
        return React12.createElement(MergeStylesShadowRootConsumer, { stylesheetKey: scope }, function(inShadow) {
          return React12.createElement(CustomizerContext.Consumer, null, function(context) {
            var _b;
            ...
            if (concatStyles && defaultProps.styles) {
              ...
              return React12.createElement(ComposedComponent, __assign({}, defaultProps, componentProps, { styles: _this._styleCache.merged }));
            }
            var styles = mergeComponentStyles(defaultProps.styles, componentProps.styles, shadowConfig);
            return React12.createElement(ComposedComponent, __assign({}, defaultProps, componentProps, { styles }));
          });
        });
      };
    ...
    })(React12.Component), _a3.displayName = "Customized" + scope, _a3.contextType = WindowContext, _a3);
...
function useCustomizationSettings(properties, scopeName) {
  ...
  var customizations = React13.useContext(CustomizerContext).customizations;
...
function useForceUpdate() {
  var _a3 = React13.useState(0), setValue = _a3[1];
  return function() {
...
var _global3 = getWindow() || {};
if (_global3[CURRENT_ID_PROPERTY] === void 0) {
  _global3[CURRENT_ID_PROPERTY] = 0;
}
...
function getId(prefix) {
  ...
  var index = _global3[CURRENT_ID_PROPERTY]++;
...
function resetIds(counter) {
  ...
  _global3[CURRENT_ID_PROPERTY] = counter;
}
...
var FocusRectsContext = React14.createContext(void 0);
function useFocusRects(rootRef) {
  var context = React14.useContext(FocusRectsContext);
...
var FocusRectsProvider = function(props) {
  ...
  var registeredProviders = React15.useState([])[0];
  var parentContext = React15.useContext(FocusRectsContext);
  ...
  if (context) {
    return React15.createElement(FocusRectsContext.Provider, { value: context }, props.children);
  } else {
    return React15.createElement(React15.Fragment, null, props.children);
  }
};
...
var useMergeStylesRootStylesheets = function() {
  return React16.useContext(MergeStylesDefaultContext).stylesheets;
};
...
var useAdoptedStylesheetEx = function(stylesheetKey, shadowCtx, rootMergeStyles, win) {
  var polyfillInsertListners = React17.useRef({});
...
var adoptSheet = function(shadowCtx, doc, stylesheetKey, stylesheet3, listenerRef) {
  var _a3, _b, _c, _d, _e;
  var shadowRoot = shadowCtx.shadowRoot;
  shadowCtx.stylesheets.set(stylesheetKey, stylesheet3);
  if (SUPPORTS_CONSTRUCTABLE_STYLESHEETS) {
    ...
    while (i >= 0 && !found) {
      ...
      var prevSortOrder = (_b = (_a3 = prevSheet.metadata) === null || _a3 === void 0 ? void 0 : _a3.sortOrder) !== null && _b !== void 0 ? _b : 0;
      var sheetSortOrder = (_d = (_c = stylesheet3.metadata) === null || _c === void 0 ? void 0 : _c.sortOrder) !== null && _d !== void 0 ? _d : 0;
      if (prevSheet.bucketName === "merge-styles" && prevSortOrder < sheetSortOrder) {
        found = true;
      }
    }
    if (SUPPORTS_MODIFYING_ADOPTED_STYLESHEETS) {
      shadowRoot.adoptedStyleSheets.splice(i + 1, 0, stylesheet3);
    } else {
    ...
    if (style.sheet) {
      cloneCSSStyleSheet(stylesheet3, style.sheet);
      if (!listenerRef[stylesheetKey]) {
        var onInsert = function(_a4) {
          var key = _a4.key, rule = _a4.rule;
        ...
        var polyfillSheet = Stylesheet.getInstance(makeShadowConfig(stylesheetKey, true, (_e = doc.defaultView) !== null && _e !== void 0 ? _e : void 0));
...
var useStyled = function(scope) {
  ...
  var _a3 = useMergeStylesHooks(), useAdoptedStylesheetEx2 = _a3.useAdoptedStylesheetEx, useShadowConfig2 = _a3.useShadowConfig, useMergeStylesShadowRootContext2 = _a3.useMergeStylesShadowRootContext, useMergeStylesRootStylesheets2 = _a3.useMergeStylesRootStylesheets, useWindow2 = _a3.useWindow;
  var win = useWindow2() || getWindow();
  var shadowCtx = useMergeStylesShadowRootContext2();
  var inShadow = !!shadowCtx;
  var rootMergeStyles = useMergeStylesRootStylesheets2();
  var shadowConfig = useShadowConfig2(scope, inShadow, win);
  useAdoptedStylesheetEx2(scope, shadowCtx, rootMergeStyles, win);
  return shadowConfig;
};

// node_modules/@fluentui/utilities/lib/shadowDom/contexts/MergeStylesRootContext.js
var React19 = __toESM(require_react());
var MergeStylesRootContext = React19.createContext(getNewContext());
var MergeStylesRootProvider = function(_a3) {
  var userSheets = _a3.stylesheets, userWindow = _a3.window, useAdoptedStylesheet2 = _a3.useAdoptedStylesheet, useAdoptedStylesheetEx2 = _a3.useAdoptedStylesheetEx, useShadowConfig2 = _a3.useShadowConfig, useMergeStylesShadowRootContext2 = _a3.useMergeStylesShadowRootContext, useHasMergeStylesShadowRootContext2 = _a3.useHasMergeStylesShadowRootContext, useMergeStylesRootStylesheets2 = _a3.useMergeStylesRootStylesheets, useWindow2 = _a3.useWindow, useStyled2 = _a3.useStyled, props = __rest(_a3, ["stylesheets", "window", "useAdoptedStylesheet", "useAdoptedStylesheetEx", "useShadowConfig", "useMergeStylesShadowRootContext", "useHasMergeStylesShadowRootContext", "useMergeStylesRootStylesheets", "useWindow", "useStyled"]);
  var win = userWindow !== null && userWindow !== void 0 ? userWindow : getWindow();
  var _b = React19.useState(function() {
    return userSheets || /* @__PURE__ */ new Map();
  }), stylesheets = _b[0], setStylesheets = _b[1];
  var sheetHandler = React19.useCallback(function(_a4) {
    var key = _a4.key, sheet = _a4.sheet;
  ...
  React19.useEffect(function() {
    setStylesheets(userSheets || /* @__PURE__ */ new Map());
  }, [userSheets]);
  React19.useEffect(function() {
    if (!win) {
      return;
  ...
  var defaultValues = React19.useMemo(function() {
    return {
      stylesheets,
      useAdoptedStylesheet: useAdoptedStylesheet2 || useAdoptedStylesheet,
      useAdoptedStylesheetEx: useAdoptedStylesheetEx2 || useAdoptedStylesheetEx,
      useShadowConfig: useShadowConfig2 || useShadowConfig,
      useMergeStylesShadowRootContext: useMergeStylesShadowRootContext2 || useMergeStylesShadowRootContext,
      useHasMergeStylesShadowRootContext: useHasMergeStylesShadowRootContext2 || useHasMergeStylesShadowRootContext,
      useMergeStylesRootStylesheets: useMergeStylesRootStylesheets2 || useMergeStylesRootStylesheets,
      useWindow: useWindow2 || useWindow,
      useStyled: useStyled2 || useStyled
    };
  }, [
    stylesheets,
    useAdoptedStylesheet2,
    useAdoptedStylesheetEx2,
    useShadowConfig2,
    useMergeStylesShadowRootContext2,
    useHasMergeStylesShadowRootContext2,
    useMergeStylesRootStylesheets2,
    useWindow2,
    useStyled2
  ]);
  return React19.createElement(
    ...
    { value: defaultValues },
    React19.createElement(MergeStylesRootContext.Provider, __assign({ value: defaultValues }, props))
  );
};
...
function styled(Component6, baseStyles, getProps, customizable2, pure) {
  ...
  var Wrapped = React20.forwardRef(function(props, forwardedRef) {
    var styles = React20.useRef(void 0);
    ...
    var useStyled2 = useMergeStylesHooks().useStyled;
    ...
    styles.current.__shadowConfig__ = useStyled2(scope);
    return React20.createElement(Component6, __assign({ ref: forwardedRef }, rest, additionalProps, props, { styles: styles.current }));
  });
  Wrapped.displayName = "Styled".concat(Component6.displayName || Component6.name);
  var pureComponent = pure ? React20.memo(Wrapped) : Wrapped;
...
function getEdgeChromiumNoHighContrastAdjustSelector() {
  var _a3;
  return _a3 = {}, // eslint-disable-next-line @typescript-eslint/no-deprecated
...
function _getFocusStyleInternal(theme, options) {
  ...
  return {
    ...
    // create a border.
    _a3[".".concat(IsFocusVisibleClassName, " &").concat(isFocusedOnly ? ":focus" : "", ":after, :host(.").concat(IsFocusVisibleClassName, ") &").concat(isFocusedOnly ? ":focus" : "", ":after")] = {
      content: '""',
      position: "absolute",
      pointerEvents,
      left: inset + 1,
...
function getFocusOutlineStyle(theme, inset, width, color) {
  ...
  return {
    selectors: (_a3 = {}, _a3[":global(".concat(IsFocusVisibleClassName, ") &:focus")] = {
...
function loadStyles(styles, loadAsync) {
  ...
  measure(function() {
    ...
    var _a3 = _themeState.runState, mode = _a3.mode, buffer = _a3.buffer, flushTimer = _a3.flushTimer;
    if (loadAsync || mode === 1) {
...
var FLUENT_CDN_BASE_URL = "https://res.cdn.office.net/files/fabric-cdn-prod_20260113.001";

// node_modules/@fluentui/style-utilities/lib/version.js
setVersion("@fluentui/style-utilities", "8.14.0");
...
//# sourceMappingURL=chunk-RIVCMYSY.js.map
